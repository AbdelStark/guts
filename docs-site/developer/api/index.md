...
See [Authentication](/developer/api/authentication) for details.

## API Sections

| Section | Description |
|---------|-------------|
| [Authentication](/developer/api/authentication) | Tokens and auth methods |
| [Repositories](/developer/api/repositories) | Repository CRUD operations |
| [Pull Requests](/developer/api/pull-requests) | PRs and code review |
| [Issues](/developer/api/issues) | Issue tracking |
| [Organizations](/developer/api/organizations) | Orgs and teams |
| [Consensus](/developer/api/consensus) | BFT consensus status |
| [Releases](/developer/api/releases) | Release management |
